...
public class UnitBehaviour_JinxFinger : MonoBehaviour
{
	[Serializable]
	...
	private void Update()
	{
		...
		case 0:
			...
			offensiveNumber = UnityEngine.Random.Range(1, offenseAmount);
			if (scriptUnitControl.attributeManaValue < scriptUnitAttribute.Offense[offensiveNumber].attackManaCost * -1)
			{
				offensiveNumber = 0;
			}
			...
			break;
		case 1:
			if (scriptUnitControl.attributeManaValue < scriptUnitControl.attackManaCost * -1)
			{
				state = 0;
			}
