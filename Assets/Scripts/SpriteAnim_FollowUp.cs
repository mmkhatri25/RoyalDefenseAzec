...
public class SpriteAnim_FollowUp : MonoBehaviour
{
	...
	private void Update()
	{
		animation1 = model.animation1;
		animation2 = model.animation2;
		animation3 = model.animation3;
		animation4 = model.animation4;
		animation5 = model.animation5;
		animation6 = model.animation6;
		animation7 = model.animation7;
		animation8 = model.animation8;
		animation9 = model.animation9;
		animation10 = model.animation10;
		if (animation1)
		{
			if (!animationx1)
			{
