...
public class Enemy_AnimationSetAddOn : MonoBehaviour
{
	public Enemy_AnimationSet MainSet;
	...
	private void Update()
	{
		AnimationTaunt = MainSet.AnimationTaunt;
		AnimationIdle = MainSet.AnimationIdle;
		AnimationRunForward = MainSet.AnimationRunForward;
		AnimationRunBackward = MainSet.AnimationRunBackward;
		AnimationWalking = MainSet.AnimationWalking;
		AnimationDashForward = MainSet.AnimationDashForward;
		AnimationDashBackward = MainSet.AnimationDashBackward;
		AnimationReadyMeleeAttack = MainSet.AnimationReadyMeleeAttack;
		AnimationMeleeAttack = MainSet.AnimationMeleeAttack;
		AnimationReadyRangeAttack = MainSet.AnimationReadyRangeAttack;
		AnimationRangeAttack = MainSet.AnimationRangeAttack;
		AnimationDisabled = MainSet.AnimationDisabled;
		AnimationRetreat = MainSet.AnimationRetreat;
		AnimationKnockAway = MainSet.AnimationKnockAway;
		if (AnimationTaunt)
		{
			if (!AnimationTauntX)
			{
